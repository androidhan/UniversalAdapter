...
public class SwitchItemActivity extends AppCompatActivity implements OnLoadMoreListener {
    ...
    public static void startActivity(Context context){
        Intent mIntent = new Intent(context,SwitchItemActivity.class);
        ...
        mButtonSwitch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View mView) {
                if(isWatefal){
                    ...
                    mUniversalAdapter.switchLayoutManager(new LinearLayoutManager(SwitchItemActivity.this));
                }else{
